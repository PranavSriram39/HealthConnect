            ...
            <nav className="navbar-desktop navbar flex items-center justify-center sm:justify-between py-3 px-5">
                ...
                <div className="hidden sm:flex sm:justify-flex sm:items-center">
                    <div className="flex cursor-pointer justify-center items-center">
                        <img className="invert mr-1" src="https://i.ibb.co/BVYRTH6/image.png" alt="home icon" />
                    ...
                    <div className="flex cursor-pointer justify-center items-center">
                        <img className="invert w-[20px] mr-1" src="https://i.ibb.co/fGWzVcv/image.png" alt="appointments icon" />
                    ...
                    {user && <div className="flex cursor-pointer justify-center items-center"><img className="invert" src="https://i.ibb.co/fDL2s6t/image.png" alt="user icon" /> <button onClick={handleLogout} className="text-lg font-extrabold mr-4 border-b border-transparent hover:border-b hover:border-white text-white ml-2">Logout</button></div>}
                </div>
            </nav>
            <div className="dropdown-menu flex justify-center items-center sm:hidden bg-white">
                <div className="flex justify-center items-center">
                    <img className="-mr-1" src="https://i.ibb.co/BVYRTH6/image.png" alt="home icon" />
                    ...
                    <div className="flex cursor-pointer justify-center items-center">
                        <img className=" w-[20px] mr-1" src="https://i.ibb.co/fGWzVcv/image.png" alt="appointments icon" />
                ...
                <div>{user && <div className="flex cursor-pointer justify-center items-center"><img className="" src="https://i.ibb.co/fDL2s6t/image.png" alt="user icon" /> <button onClick={handleLogout} className="text-sm text-center font-extrabold text-gray-700 block border-b border-transparent hover:border-b hover:border-slate-700">Logout</button></div>}</div>
